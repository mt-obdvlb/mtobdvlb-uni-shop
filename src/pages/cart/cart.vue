...
<template>
  <scroll-view class="scroll-view" scroll-y>
    ...
    <template v-if="memberStore.profile">
      <!-- 购物车列表 -->
      <view v-if="cartList?.length" class="cart-list">
        <!-- 优惠提示 -->
        <view class="tips">
          ...
          <uni-swipe-action-item v-for="item in cartList" :key="item.skuId" class="cart-swipe">
            ...
            <view class="goods">
              ...
              <navigator
                ...
                hover-class="none"
              >
                <image :src="item.picture" class="picture" mode="aspectFill"></image>
                <view class="meta">
              ...
              <view class="count">
                ...
                <input :value="item.count.toString()" class="input" type="number" />
                <text class="text">+</text>
              </view>
            </view>
            <!-- 右侧删除按钮 -->
      ...
      <view v-else class="cart-blank">
        <image class="image" src="/static/images/blank_cart.png" />
