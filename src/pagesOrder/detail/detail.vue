...
<template>
  ...
  <view :style="{ paddingTop: safeAreaInsets?.top + 'px' }" class="navbar">
    <view class="wrap">
      ...
      ></navigator>
      <navigator v-else class="back icon-home" open-type="switchTab" url="/pages/index/index">
      </navigator>
  ...
  <scroll-view id="scroller" class="viewport" scroll-y @scrolltolower="onScrolltolower">
    <template v-if="order">
      ...
      <view class="goods">
        <view class="item">
          ...
          <view v-if="true" class="action">
            ...
            <navigator class="button" url=""> 去评价 </navigator>
          </view>
        </view>
        <!-- 合计 -->
        <view class="total">
      ...
      <!-- 底部操作栏 -->
      <view :style="{ paddingBottom: safeAreaInsets?.bottom + 'px' }" class="toolbar-height"></view>
    ...
    <view class="popup-root">
      ...
      <view class="description">
        ...
        <view v-for="item in reasonList" :key="item" class="cell" @tap="reason = item">
          ...
          <text :class="{ checked: item === reason }" class="icon"></text>
        </view>
      </view>
      <view class="footer">
